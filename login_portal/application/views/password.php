            ...
            ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form action="admin/newPassChng" method="post" role="form"  class="form-horizontal">
                                
                                <div class="form-group">
                                    <label for="newpass" class="col-sm-2">Old Password : </label>
                                    <div class="input-group col-sm-4">
                                        <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                                        <input type="password" name="opass" id="oldpass" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                                        <input type="password" name="npass" id="newpass" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                                        <input type="password" name="cpass" id="conpass" class="form-control" onkeyup = "matchPass(newpass.value,this.value)" />
                                    </div>
                                </div>
