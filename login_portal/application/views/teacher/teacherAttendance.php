...
<script type="text/javascript">
    function popURL( URL ){
        var newwindow = window.open(URL,'_blank','height=650,width=1200,left=70,scrollbars=yes,top=10,replace=false,titlebar=no,location=no');
...
<?php $j++; endfor; ?>
            ...
            <button class="btn btn-success" style="margin-top:10px;margin-left:48%;width:150px;" onclick="popURL('teacher/printAttendance/<?php echo $y ?>/<?php echo $tid ?>')">
                <span class="glyphicon glyphicon-print"></span>  Print Attendance
            </button>
            </div>
