...
<script type="text/javascript">
    ...
    function RecPaclassSection(cls){
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById("ReSec").innerHTML="";
                document.getElementById("ReSec").innerHTML="<option value=''>Select</option>";

                for(var i=0;i<secExt.length;i++){
                    document.getElementById("ReSec").innerHTML+="<option value='"+secExt[i]+"'>"+secExt[i]+"</option>";
                }
		...
		<div class="container-fluid">
			<div class="col-md-12"> -->
				<div class="panel panel-default" style="margin-top:20px;">
                    <form action="index.php/xmReport/disPaReRepo" method="post" class="form-inline">
                            <table class="table" id="recRep">
                               <?php
                               ...
                               ?>
                                ...
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        <select name="class" id="cls" onchange="RecPaclassSection(this.value)" class="form-control" required style="min-width:200px;">
                                ...
                                <tr>
                                    <td>Section :</td>
                                    <td>
                                        <select name="sec"  id="ReSec" class="form-control" required style="min-width:200px;" >
