...
function showAjaxModal(url){
	...
	jQuery('#modal_ajax .modal-body').load(receipturl);
}
...
function receiptModalFunction(url){
	...
	var str=url.split("/");
	var receipturl="account_billgenerate/bill_description/"+str[3];
	var printurl="account_billgenerate/receiptCopyPrint/"+str[3];
	$("#printlinkrecipt").attr("href",printurl);
	jQuery('#receiptModal .modal-body').load(url);
...
?>
			...
			<tr>
				...
				<td><?php echo number_format($report->payment,2); ?></td>
				<td><?php echo date("Y-m-d",strtotime($report->bdate)); ?></td>
				<td><?php echo date("Y-m-d",strtotime($report->pdate)); ?></td>
				<td>
					<a href="account_billgenerate/receiptCopyPrint/<?php echo $report->trans_id ?>" target="_blank" ><button class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-print"></span> Print</button></a>
				</td>
			</tr>
<?php
	endforeach;
		...
		<div class="modal-dialog modal-lg" style="width:900px;">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-footer">
			  ...
			  <button type="submit" class="btn btn-default" id="paymentBtn" name="invSearch" ><span class="glyphicon glyphicon-send"></span> Payment</button>
...
<div class="modal fade" id="receiptModal" role="dialog">
		<div class="modal-dialog" style="width:900px;">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-footer">
			  <a href="javascript:void(0);" id="printlinkrecipt" target="_blank">
