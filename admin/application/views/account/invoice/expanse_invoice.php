		...
		<div id="content" class="box" style="border:1px solid #000;margin:0 auto;">
			<div style="width:700px;border:0px solid red;height:105px; margin-top:20px;">
					...
					<div style="width:300px;border:0px solid green;float:left;">
						<p style="font-size:22px; text-align:center;margin:1px 0px 0px 0px;">Expanse Money Receipt</p>	
						<p style="font-size:20px;text-align:center;margin:1px 0px 0px 0px;">(Expanse Copy)</p>	
					...
					<div style="width:700px;border:0px solid red;height:80px;">
						...
						<?php 
							...
							$appsql=$this->db->query("select * from expance where invoice_no='$invos'")->row();
						?>
									<table style="margin-left:15px;">
										...
										<tr height="25px;">
											<td>Category</td>
											<td>:</td>
											<td><?php echo $appsql->expance_type;?></td>
										</tr>										
									</table>
						</div>
