...
<aside class="right-side">      <!---rightbar start here --->
              <!-- Content Header (Page header) -->
				...
				<div class="row">
						<div class="col-sm-12">
						<form class="form-horizontal" role="form" action="index.php/account_edit/search_expanse" method="post">
						<div class="form-group">
							...
							<select class="form-control" name="categoryid">
									...
									?>
										<option value="<?php echo $accidshows->expance_type?>" <?php if($catgid==$accidshows->expance_type){echo "SELECTED";}?>><?php echo $accidshows->expance_type?></option>
										<?php }?>
							</select>
							</div>	
								<div class="col-sm-2">
						 ...
						 <div class="table-responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $row->expance_type?></td>
								
									<td><?php $method=$row->method;if($method==1){echo 'Cash';}else{echo 'Check';}?></td>
									<td><?php echo $row->check_no?></td>
									<td><?php echo $row->pay_person	?></td>
									<td><?php  $cdate=$row->expire_date;if($cdate>0){echo date('M-d-Y',strtotime($cdate));}?></td>
