...
$(document).ready(function(){
 $('#userReg').submit(function() {
  $.post(
            "index.php/userpanel/user_registation_insert",
            $("#userReg").serialize(),
            function(data){
              if(data==1)
			  {
				  $("#msg").show('slow'); 
					setTimeout(function(){					
					window.location="index.php/userpanel/user_registations";
					},2000)
			  }
			  else if(data==2)
			  {
				  ...
				  alert('User Name not support special characture.');
			  }
			  else if(data==4){
	...
	if(x!=y){		
			...
			alert('Password Not Match.');
                ...
                <section class="content">
                    ...
                    <div class="row">
                      <div class="col-md-10">
					 <form class="form-horizontal" role="form" action="index.php/userpanel/user_registation_insert" method="post" name="userReg" id="userReg">
						<div class="form-group">
						  <label class="control-label col-sm-2" >User Name:</label>
						  <div class="col-sm-6">          
							<input type="text" name="username"  class="form-control" id="username" required placeholder="Enter User Name" onkeyup="AllowAlphabet()"/>
						  </div>						  
						</div>
						<div class="form-group">
						  <label class="control-label col-sm-2" >Full Name:</label>
						  <div class="col-sm-6">          
							<input type="text" name="fullname"  class="form-control" id="accname" required placeholder="Enter Full Name"/>
						  </div>						  
						</div>
						<div class="form-group">
						...
						<div class="form-group" >
						  ...
						  <div class="col-sm-6" id="errorid">          
							<input type="password" name="confirmpass"  class="form-control" id="confirmpass" required placeholder="Enter Retype Password" onblur="passwords()"/>
						  </div>						  
						</div>
						<div class="form-group">
						  <label class="control-label col-sm-2" >Rule Name:</label>
							  <div class="col-sm-6">
								<select class="form-control" name="rulename" required>
									...
									?>
										<option value="<?php echo $accidshow->ruleid?>"><?php echo $accidshow->ruleN?></option>
										<?php }?>
								</select>
							  </div>					  
						</div>
						<div class="form-group">
						  ...
						  <div class="col-sm-6" >          
							<input type="text" name="phonenumber"  class="form-control" id="openbalance" required placeholder="Enter Phone Number"/>
						  </div>						  
						</div>
						<div class="form-group">
						  <label class="control-label col-sm-2" >Email Address:</label>
						  <div class="col-sm-6" >          
							<input type="email" name="emailadd"  class="form-control" id="email" required placeholder="Enter Email Address"/>
						  </div>						  
						</div>
						<div class="form-group">        
					...
					<div id='msg'><p>Save Record Successfully.</p></div>
