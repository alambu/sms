...
$("#dob").datepicker({format: 'yyyy-mm-dd'});
	...
	$.ajax({  
		 type: "POST",  
		 url: "index.php/admission_submit/application_form",  
		 data: formData,
		 async: false,
		 cache: false,
		 contentType: false,
		 ...
		 success: function(data) {
			 ...
			 {	
				...
				window.location="admission_section/application_details?d="+data;
			 }
			 else { 
			 alert(data);
...
<!--Content Start-->
			...
			<div class="row">
			  <div class="col-md-12">
				...
				<form  class="form-horizontal" role="form" action="index.php/admission_submit/application_form" method="post" enctype="multipart/form-data" id="application_form">
