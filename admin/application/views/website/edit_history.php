...
<section class="content">
	<form role="form" action="index.php/website/updateHistory" method="post" enctype="multipart/form-data" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-4"></div>

					<div class="col-md-2">
						<input type="hidden" name="msgid" id="msgid" value="<?php echo $id; ?>" />
					<img src="img/document/history/<?php echo $edit->image; ?>" class="img-thumbnail" height="120" width="155" name="preImg" id="preImg"/>
