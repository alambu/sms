...
function selected_class_edit(sftid)
{
	$.ajax({
	...
	success: function(data)
	{
		...
		document.getElementById("class_catg_edit").innerHTML='';
		document.getElementById("class_catg_edit").innerHTML="<option value=''>"+sec+"</option>";
		
		for(var i=0;i<d.length;i++){
			
			document.getElementById("class_catg_edit").innerHTML+="<option value='"+d1[i]+"'>"+d[i]+"</option>";
		}
	}
	else {
		document.getElementById("class_catg_edit").innerHTML='';
		document.getElementById("class_catg_edit").innerHTML="<option value=''>Select Class</option>";
	}
...
function section_routine_show_edit(frm)
{
    var sft,year,cls;
	...
	url='class_routine/section_routine_show_edit?sft='+sft+'&year='+year+'&cls='+cls;
	$("#sec_show_edit").empty();
	$("#sec_show_edit").empty().append('<p align="center" style="margin-top:5%"><img src="img/line.gif"></p>');
	$("#sec_show_edit").load(url);
					...
					<td>
						<div class="form-group">
							...
							<div class="col-md-3">
								...
								<select name="shift" id="shift" class="form-control" onchange="selected_class_edit(this.value);" required>
							...
							<div class="col-md-3">
								...
								<select name="class_catg" id="class_catg_edit" class="form-control" required >
									<option value="">Select</option>
							...
							<div class="col-md-3">
								<label  for="pwd"></label>
								<button style="margin-top:24px;" type="button" name="search" onclick="section_routine_show_edit(this.form);" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span>  Search</button>
							</div> 
