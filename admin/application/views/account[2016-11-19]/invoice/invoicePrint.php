...
break;
endforeach;
$billmonth=$this->accmodone->getMonthName($monthfdate);
?>
		...
		<div class="fix top-side">
			...
			<div class="fix mid-top">
				...
				<div class="mid-top-right floatright">
					...
					<p>
						<span>Last Payment Date: </span><span class="date-style"><?php echo $lastDate; ?></span>
					</p>
					<p>
						<span>Payment Date: </span><span class="date-style"><?php echo "YYYY-mm-dd"; ?></span>
					</p>
				</div>
			</div>
			...
			<div class="fix mid-studentTaka">
				<div class="mid-studentTaka-left floatleft">
					<h3>Description</h3>
					<?php 
					...
					?>
					<p><?php echo $feesName[$i].' * '.$tmonth.' '.$waver; ?></p>
					...
					if($vahicles->amount):
						...
						echo "<p>Vahicales Rent * $tmonth</p>";
					endif;
					// end
					?>
					...
					<p class="highlightamount">Total</p>
					<p class="highlightamount">Present Due</p>
					

				</div>
				<div class="mid-studentTaka-right floatright">
					<h3>Amount</h3>
					<?php 
					for($i = 0;$i < count($feesName);$i++):
					$waver="";
					...
					$tbill += $feesId[$i];
					?>
					<p><?php echo $feesId[$i]; ?></p>
					
					<?php 
					
					if($vahicles->amount):
						
						echo "<p>$vahicles->amount*$tmonth</p>";
					endif;
					// end
					?>
					...
					<p class="highlightamount no-indent"><?php echo $value->total_bill; ?></p>
					<p class="highlightamount no-indent"><?php echo $dueAmount; ?></p>
				</div>
			</div>
		...
		<div class="fix stracture bottom-side">
			...
			<div class="fix mid-studentTaka">
				...
				<div class="mid-studentTaka-right floatright">
					...
					<p class="highlightamount no-indent"><?php $value->total_bill; ?></p>
					<p class="highlightamount no-indent"><?php echo $dueAmount; ?></p>
				</div>
			</div>
			<div class="fix stracture inwords-div"> 
