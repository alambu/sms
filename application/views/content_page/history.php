		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" style="min-height:770px;">
				<p style="text-align: justify; line-height: 1.6;">
					<img style="width: 350px; height: 200px; float: left; border: 1px solid #EDEDED; padding: 5px; margin: -3px 10px 0px 0px;" class="img-responsive" src="admin/img/document/history/<?php echo $select->image ?>" alt="Welcome to" />
