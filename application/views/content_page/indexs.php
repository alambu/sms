					 ...
					 <div class="rightbar5">
						...
						<div class="dis_5">
							<table height="200px" cellpadding="1" cellspacing="0" border="0" width="190px" align="center" style="margin-top:5px; ">
							   ...
							   <tr>
								   <td colspan="2" style="text-align:center;"><input type="submit" name="Send" value="Send" style="border:none; border-radius:5px; background-color:darkgreen; color: white; font-weight:bold;" /></td>
							   </tr>
